...
public class Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
            ...
            presentBox.getChildren().add(anchor);
    ...
    @FXML
    private void onStop(Eent evt){
        createBoard(DEFAULT_SIZE,0);
    }
    
    @FXML
    private void onClear(Event evt){
        createBoard(DEFAULT_SIZE,(dobule) countSlider.getValue()/100);
    }
    ...
    private void onSlide(Event evt){
        countSlider.valueProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observableValue, Number oldValue, Number newValue) {
                ...
                createBoard(DEFAULT_SIZE,(double) newValue.intValue());
            }
        });
    }
    ...
    private void onAbout(Event evt){
        Text text1=new Text("Game of Life\n");
